...
now = 0
switch_flag = False
yupiao_pix = pyautogui.pixel(1764, 322)
...
def check_have_fish():
    ...
    now_yupiao_pix = pyautogui.pixel(1764, 322)
    logger.info('---')
    logger.info(now_yupiao_pix)
    logger.info(yupiao_pix)
    logger.info('+++')
    if now_yupiao_pix == yupiao_pix:
        logger.info('鱼漂动了')
        return True
    ...
    # if have_fish_color_check1:
    #     logger.info('能量条变蓝了')
    # have_fish_color_check2 = pyautogui.pixelMatchesColor(1755, 348, (214, 210, 209), tolerance=100)
    # # 晚上
    # # have_fish_color_check2 = pyautogui.pixelMatchesColor(1764, 318, (184, 185, 186), tolerance=50)
    # if not have_fish_color_check2:
    #     logger.info('鱼漂动了')
    # if (not have_fish_color_check2) or have_fish_color_check1:
    #     return True
    # return False
